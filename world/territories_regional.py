...
REGIONAL_TERRITORIES["midsouth"] = {
    ...
    "exits": [
        ("backstage", "ms_arena", "ms_backstage"),
        ("arena", "ms_backstage", "ms_arena"),
        ("gym", "ms_arena", "ms_gym"),
        ("arena", "ms_gym", "ms_arena"),
        ("bar", "ms_arena", "ms_bar"),
        ("arena", "ms_bar", "ms_arena"),
        ("office", "ms_backstage", "ms_office"),
        ("backstage", "ms_office", "ms_backstage"),
        ("travel", "ms_arena", "ms_travel"),
        ("back", "ms_travel", "ms_arena"),
    ],
}
...
REGIONAL_TERRITORIES["midatlantic"] = {
    ...
    "exits": [
        ("backstage", "ma_arena", "ma_backstage"),
        ("arena", "ma_backstage", "ma_arena"),
        ("gym", "ma_arena", "ma_gym"),
        ("arena", "ma_gym", "ma_arena"),
        ("bar", "ma_arena", "ma_bar"),
        ("arena", "ma_bar", "ma_arena"),
        ("office", "ma_backstage", "ma_office"),
        ("backstage", "ma_office", "ma_backstage"),
        ("studio", "ma_arena", "ma_studio"),
        ("arena", "ma_studio", "ma_arena"),
        ("travel", "ma_arena", "ma_travel"),
        ("back", "ma_travel", "ma_arena"),
    ],
}
...
REGIONAL_TERRITORIES["florida"] = {
    ...
    "exits": [
        ("backstage", "fl_arena", "fl_backstage"),
        ("arena", "fl_backstage", "fl_arena"),
        ("gym", "fl_arena", "fl_gym"),
        ("swamp", "fl_arena", "fl_gym"),
        ("arena", "fl_gym", "fl_arena"),
        ("bar", "fl_arena", "fl_bar"),
        ("arena", "fl_bar", "fl_arena"),
        ("office", "fl_backstage", "fl_office"),
        ("backstage", "fl_office", "fl_backstage"),
        ("travel", "fl_arena", "fl_travel"),
        ("back", "fl_travel", "fl_arena"),
    ],
}
...
REGIONAL_TERRITORIES["georgia"] = {
    ...
    "exits": [
        ("backstage", "ga_arena", "ga_backstage"),
        ("arena", "ga_backstage", "ga_arena"),
        ("gym", "ga_arena", "ga_gym"),
        ("arena", "ga_gym", "ga_arena"),
        ("studio", "ga_arena", "ga_studio"),
        ("tbs", "ga_arena", "ga_studio"),
        ("arena", "ga_studio", "ga_arena"),
        ("office", "ga_backstage", "ga_office"),
        ("backstage", "ga_office", "ga_backstage"),
        ("travel", "ga_arena", "ga_travel"),
        ("back", "ga_travel", "ga_arena"),
    ],
}
...
REGIONAL_TERRITORIES["wccw"] = {
    ...
    "exits": [
        ("backstage", "wc_arena", "wc_backstage"),
        ("arena", "wc_backstage", "wc_arena"),
        ("gym", "wc_arena", "wc_gym"),
        ("arena", "wc_gym", "wc_arena"),
        ("ranch", "wc_arena", "wc_ranch"),
        ("arena", "wc_ranch", "wc_arena"),
        ("office", "wc_backstage", "wc_office"),
        ("backstage", "wc_office", "wc_backstage"),
        ("travel", "wc_arena", "wc_travel"),
        ("back", "wc_travel", "wc_arena"),
    ],
}
...
REGIONAL_TERRITORIES["awa"] = {
    ...
    "exits": [
        ("backstage", "awa_arena", "awa_backstage"),
        ("arena", "awa_backstage", "awa_arena"),
        ("gym", "awa_arena", "awa_gym"),
        ("barn", "awa_arena", "awa_gym"),
        ("arena", "awa_gym", "awa_arena"),
        ("bar", "awa_arena", "awa_bar"),
        ("club", "awa_arena", "awa_bar"),
        ("arena", "awa_bar", "awa_arena"),
        ("farm", "awa_arena", "awa_farm"),
        ("arena", "awa_farm", "awa_arena"),
        ("office", "awa_backstage", "awa_office"),
        ("backstage", "awa_office", "awa_backstage"),
        ("travel", "awa_arena", "awa_travel"),
        ("back", "awa_travel", "awa_arena"),
    ],
}
...
REGIONAL_TERRITORIES["stampede"] = {
    ...
    "exits": [
        ("backstage", "stm_arena", "stm_backstage"),
        ("arena", "stm_backstage", "stm_arena"),
        ("gym", "stm_arena", "stm_gym"),
        ("dungeon", "stm_arena", "stm_gym"),
        ("arena", "stm_gym", "stm_arena"),
        ("office", "stm_backstage", "stm_office"),
        ("backstage", "stm_office", "stm_backstage"),
        ("travel", "stm_arena", "stm_travel"),
        ("back", "stm_travel", "stm_arena"),
    ],
}
...
REGIONAL_TERRITORIES["pnw"] = {
    ...
    "exits": [
        ("backstage", "pnw_arena", "pnw_backstage"),
        ("arena", "pnw_backstage", "pnw_arena"),
        ("gym", "pnw_arena", "pnw_gym"),
        ("arena", "pnw_gym", "pnw_arena"),
        ("bar", "pnw_arena", "pnw_bar"),
        ("arena", "pnw_bar", "pnw_arena"),
        ("office", "pnw_backstage", "pnw_office"),
        ("backstage", "pnw_office", "pnw_backstage"),
        ("travel", "pnw_arena", "pnw_travel"),
        ("back", "pnw_travel", "pnw_arena"),
    ],
}
