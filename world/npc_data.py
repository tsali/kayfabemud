...
NPC_WRESTLERS = [
    ...
    # TERRITORY ERA (#1-50)
    # ----------------------------------------------------------
    {"npc_id": 1, "name": "Rick Fontaine", "based_on": "Ric Flair", "territory": "midatlantic", "role": "wrestler", "alignment": "Heel", "finisher_name": "Figure-Four Leglock", "finisher_type": "technical", "level": 40, "stats": (12, 11, 16, 20, 13, 19), "signature_moves": ["figure_four", "knife_edge_chop", "backdrop_suplex"]},
    ...
    {"npc_id": 3, "name": "Ricky Riverdale", "based_on": "Ricky Steamboat", "territory": "midatlantic", "role": "wrestler", "alignment": "Face", "finisher_name": "Deep Body Press", "finisher_type": "aerial", "level": 38, "stats": (12, 16, 17, 16, 13, 18), "signature_moves": ["deep_arm_drag", "chop_flurry", "crossbody"]},
    ...
    {"npc_id": 8, "name": "Hawk Hogan", "based_on": "Hulk Hogan", "territory": "wwf", "role": "wrestler", "alignment": "Face", "finisher_name": "Atomic Leg Drop", "finisher_type": "charisma", "level": 45, "stats": (16, 7, 8, 20, 17, 14), "signature_moves": ["atomic_leg_drop", "big_boot", "hulk_up"]},
    ...
    {"npc_id": 11, "name": '"Wild Man" Randy Salvatore', "based_on": "Randy Savage", "territory": "wwf", "role": "wrestler", "alignment": "Heel", "finisher_name": "Flying Elbow Drop", "finisher_type": "aerial", "level": 40, "stats": (13, 14, 13, 18, 14, 17), "signature_moves": ["old_school", "clothesline", "knee_drop"]},
    ...
    {"npc_id": 13, "name": 'Jake "The Serpent" Rollins', "based_on": "Jake Roberts", "territory": "wwf", "role": "wrestler", "alignment": "Anti-Hero", "finisher_name": "DDT", "finisher_type": "technical", "level": 36, "stats": (12, 9, 14, 17, 13, 20), "signature_moves": ["ddt", "short_arm_clothesline", "knee_lift"]},
    {"npc_id": 14, "name": "The Gravedigger", "based_on": "Undertaker", "territory": "wwf", "role": "wrestler", "alignment": "Anti-Hero", "finisher_name": "Tombstone Piledriver", "finisher_type": "power", "level": 44, "stats": (16, 10, 13, 18, 18, 17), "signature_moves": ["tombstone", "chokeslam", "old_school"]},
    {"npc_id": 15, "name": "Brett Harmon", "based_on": "Bret Hart", "territory": "stampede", "role": "wrestler", "alignment": "Face", "finisher_name": "Sharpshooter", "finisher_type": "technical", "level": 42, "stats": (13, 13, 19, 15, 15, 19), "signature_moves": ["sharpshooter", "backbreaker", "russian_leg_sweep"]},
    ...
    {"npc_id": 25, "name": "Jerry Crowley", "based_on": "Jerry Lawler", "territory": "memphis", "role": "wrestler", "alignment": "Anti-Hero", "finisher_name": "Piledriver", "finisher_type": "power", "level": 35, "stats": (13, 9, 12, 19, 14, 18), "signature_moves": ["piledriver", "ddt", "big_boot"]},
    ...
    {"npc_id": 33, "name": "Kurt Hennison", "based_on": "Curt Hennig", "territory": "awa", "role": "wrestler", "alignment": "Heel", "finisher_name": "Perfectplex", "finisher_type": "technical", "level": 36, "stats": (13, 14, 16, 16, 12, 17), "signature_moves": ["perfectplex", "dropkick", "standing_neckbreaker"]},
    ...
    {"npc_id": 45, "name": "Stuart Harmon", "based_on": "Stu Hart", "territory": "stampede", "role": "trainer", "alignment": "Face", "finisher_name": "Stretching", "finisher_type": "technical", "level": 40, "stats": (14, 6, 20, 12, 17, 20), "signature_moves": ["crossface", "arm_wringer", "stretch_muffler"]},
    {"npc_id": 46, "name": "Terry Bronco", "based_on": "Terry Funk", "territory": "wccw", "role": "wrestler", "alignment": "Anti-Hero", "finisher_name": "Spinning Toe Hold", "finisher_type": "technical", "level": 38, "stats": (14, 9, 15, 16, 17, 18), "signature_moves": ["spinning_toe_hold", "moonsault_sig", "piledriver"]},
    {"npc_id": 47, "name": "Stan Hanssen", "based_on": "Stan Hansen", "territory": "japan", "role": "wrestler", "alignment": "Anti-Hero", "finisher_name": "Western Lariat", "finisher_type": "power", "level": 38, "stats": (18, 8, 13, 12, 18, 15), "signature_moves": ["western_lariat", "bodyslam", "knee_drop"]},
    ...
    # ----------------------------------------------------------
    {"npc_id": 51, "name": "Chief Afa Savea", "based_on": "Afa Anoa'i", "territory": "pensacola", "role": "trainer", "alignment": "Face", "finisher_name": "Samoan Drop", "finisher_type": "power", "level": 40, "stats": (16, 8, 14, 15, 18, 19), "signature_moves": ["samoan_drop", "samoan_headbutt", "headbutt"]},
    ...
    {"npc_id": 53, "name": "Master Matsuda", "based_on": "Hiro Matsuda", "territory": "pensacola", "role": "trainer", "alignment": "Heel", "finisher_name": "Leg Break", "finisher_type": "technical", "level": 40, "stats": (14, 10, 20, 12, 16, 20), "signature_moves": ["leg_breaker", "snap_suplex", "stretch_muffler"]},
    ...
    {"npc_id": 69, "name": "High Chief Pita Maivia", "based_on": "Peter Maivia", "territory": "pensacola", "role": "trainer", "alignment": "Face", "finisher_name": "Headbutt", "finisher_type": "power", "level": 35, "stats": (15, 8, 12, 14, 16, 16), "signature_moves": ["samoan_headbutt", "samoan_drop", "chop_flurry"]},
    ...
    # ----------------------------------------------------------
    {"npc_id": 104, "name": '"Ice Cold" Steve Austen', "based_on": "Steve Austin", "territory": "wwf", "role": "wrestler", "alignment": "Anti-Hero", "finisher_name": "Stone Cold Stunner", "finisher_type": "technical", "level": 44, "stats": (15, 10, 14, 19, 16, 17), "signature_moves": ["ddt", "knee_drop", "clothesline"]},
    ...
    {"npc_id": 118, "name": "Harley Reece", "based_on": "Harley Race", "territory": "midsouth", "role": "wrestler", "alignment": "Heel", "finisher_name": "Diving Headbutt", "finisher_type": "aerial", "level": 38, "stats": (16, 8, 15, 14, 18, 18), "signature_moves": ["knee_drop", "snap_suplex", "backdrop_suplex"]},
    ...
    # WCW (#134-148)
    # ----------------------------------------------------------
    {"npc_id": 134, "name": '"The Scorpion" Steve Borden', "based_on": "Sting", "territory": "wcw", "role": "wrestler", "alignment": "Face", "finisher_name": "Scorpion Deathlock", "finisher_type": "technical", "level": 40, "stats": (15, 12, 14, 18, 15, 16), "signature_moves": ["sharpshooter", "big_boot", "crossbody"]},
    ...
    # ----------------------------------------------------------
    {"npc_id": 149, "name": "Hunter Hearst Hampton", "based_on": "Triple H", "territory": "wwf", "role": "wrestler", "alignment": "Heel", "finisher_name": "Pedigree", "finisher_type": "power", "level": 42, "stats": (16, 11, 14, 17, 16, 17), "signature_moves": ["knee_lift", "spinebuster", "standing_neckbreaker"]},
    {"npc_id": 150, "name": '"The Showstopper" Shane Mitchell', "based_on": "Shawn Michaels", "territory": "wwf", "role": "wrestler", "alignment": "Face", "finisher_name": "Sweet Chin Music", "finisher_type": "aerial", "level": 42, "stats": (12, 17, 16, 18, 12, 19), "signature_moves": ["moonsault_sig", "deep_arm_drag", "chop_flurry"]},
    ...
    {"npc_id": 166, "name": '"The Foundation" Dwayne Maivia', "based_on": "The Rock", "territory": "wwf", "role": "wrestler", "alignment": "Anti-Hero", "finisher_name": "Rock Bottom", "finisher_type": "power", "level": 44, "stats": (15, 11, 12, 20, 15, 17), "signature_moves": ["ddt", "samoan_drop", "knee_lift"]},
