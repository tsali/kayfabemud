...
SCHOOL_TERRITORIES["slaughterhouse"] = {
    ...
    "exits": [
        ("inside", "slaught_entrance", "slaught_floor"),
        ("floor", "slaught_entrance", "slaught_floor"),
        ("out", "slaught_floor", "slaught_entrance"),
        ("ring", "slaught_floor", "slaught_ring"),
        ("floor", "slaught_ring", "slaught_floor"),
        ("office", "slaught_floor", "slaught_office"),
        ("floor", "slaught_office", "slaught_floor"),
        ("road", "slaught_entrance", "slaught_road"),
        ("back", "slaught_road", "slaught_entrance"),
    ],
}
...
SCHOOL_TERRITORIES["beast_works"] = {
    ...
    "exits": [
        ("inside", "beast_entrance", "beast_floor"),
        ("floor", "beast_entrance", "beast_floor"),
        ("out", "beast_floor", "beast_entrance"),
        ("ring", "beast_floor", "beast_ring"),
        ("floor", "beast_ring", "beast_floor"),
        ("road", "beast_entrance", "beast_road"),
        ("back", "beast_road", "beast_entrance"),
    ],
}
...
SCHOOL_TERRITORIES["conservatory"] = {
    ...
    "exits": [
        ("inside", "cons_entrance", "cons_floor"),
        ("floor", "cons_entrance", "cons_floor"),
        ("out", "cons_floor", "cons_entrance"),
        ("ring", "cons_floor", "cons_ring"),
        ("floor", "cons_ring", "cons_floor"),
        ("road", "cons_entrance", "cons_road"),
        ("back", "cons_road", "cons_entrance"),
    ],
}
...
SCHOOL_TERRITORIES["dungeon_holds"] = {
    ...
    "exits": [
        ("inside", "dung_entrance", "dung_floor"),
        ("down", "dung_entrance", "dung_floor"),
        ("out", "dung_floor", "dung_entrance"),
        ("up", "dung_floor", "dung_entrance"),
        ("ring", "dung_floor", "dung_ring"),
        ("floor", "dung_ring", "dung_floor"),
        ("road", "dung_entrance", "dung_road"),
        ("back", "dung_road", "dung_entrance"),
    ],
}
...
SCHOOL_TERRITORIES["proving_grounds"] = {
    ...
    "exits": [
        ("inside", "prov_entrance", "prov_floor"),
        ("floor", "prov_entrance", "prov_floor"),
        ("out", "prov_floor", "prov_entrance"),
        ("ring", "prov_floor", "prov_ring"),
        ("floor", "prov_ring", "prov_floor"),
        ("road", "prov_entrance", "prov_road"),
        ("back", "prov_road", "prov_entrance"),
    ],
}
