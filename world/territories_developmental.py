...
DEVELOPMENTAL_TERRITORIES["ovw"] = {
    ...
    "exits": [
        ("backstage", "ovw_arena", "ovw_backstage"),
        ("arena", "ovw_backstage", "ovw_arena"),
        ("gym", "ovw_arena", "ovw_gym"),
        ("arena", "ovw_gym", "ovw_arena"),
        ("corwin", "ovw_backstage", "ovw_corwin"),
        ("cornette", "ovw_backstage", "ovw_corwin"),
        ("backstage", "ovw_corwin", "ovw_backstage"),
        ("frost", "ovw_backstage", "ovw_frost"),
        ("backstage", "ovw_frost", "ovw_backstage"),
        ("bar", "ovw_arena", "ovw_bar"),
        ("arena", "ovw_bar", "ovw_arena"),
        ("travel", "ovw_arena", "ovw_travel"),
        ("road", "ovw_arena", "ovw_travel"),
        ("back", "ovw_travel", "ovw_arena"),
    ],
}
...
DEVELOPMENTAL_TERRITORIES["fcw"] = {
    ...
    "exits": [
        ("backstage", "fcw_arena", "fcw_backstage"),
        ("arena", "fcw_backstage", "fcw_arena"),
        ("gym", "fcw_arena", "fcw_gym"),
        ("arena", "fcw_gym", "fcw_arena"),
        ("truck", "fcw_arena", "fcw_truck"),
        ("production", "fcw_arena", "fcw_truck"),
        ("arena", "fcw_truck", "fcw_arena"),
        ("travel", "fcw_arena", "fcw_travel"),
        ("back", "fcw_travel", "fcw_arena"),
    ],
}
...
DEVELOPMENTAL_TERRITORIES["dsw"] = {
    ...
    "exits": [
        ("backstage", "dsw_arena", "dsw_backstage"),
        ("arena", "dsw_backstage", "dsw_arena"),
        ("gym", "dsw_arena", "dsw_gym"),
        ("bootcamp", "dsw_arena", "dsw_gym"),
        ("arena", "dsw_gym", "dsw_arena"),
        ("office", "dsw_backstage", "dsw_office"),
        ("backstage", "dsw_office", "dsw_backstage"),
        ("travel", "dsw_arena", "dsw_travel"),
        ("back", "dsw_travel", "dsw_arena"),
    ],
}
...
DEVELOPMENTAL_TERRITORIES["hwa"] = {
    ...
    "exits": [
        ("backstage", "hwa_arena", "hwa_backstage"),
        ("arena", "hwa_backstage", "hwa_arena"),
        ("gym", "hwa_arena", "hwa_gym"),
        ("classroom", "hwa_arena", "hwa_gym"),
        ("arena", "hwa_gym", "hwa_arena"),
        ("interview", "hwa_arena", "hwa_interview"),
        ("set", "hwa_arena", "hwa_interview"),
        ("arena", "hwa_interview", "hwa_arena"),
        ("bar", "hwa_arena", "hwa_bar"),
        ("arena", "hwa_bar", "hwa_arena"),
        ("travel", "hwa_arena", "hwa_travel"),
        ("back", "hwa_travel", "hwa_arena"),
    ],
}
