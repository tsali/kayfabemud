...
def node_apply_fed(caller, raw_string, **kwargs):
    ...
    text = (
        ...
        "|w=== WELCOME TO THE TERRITORIES ===|n\n\n"
        "You made it. Now prove you belong.\n\n"
        "  |wsouth|n           - Head into the venue\n"
        "  |wcard|n            - See who's here to fight\n"
        "  |wwrestle <name>|n  - Challenge someone\n"
        "  |wpromo fire|n      - Cut a promo (build rep)\n"
        "  |wmap|n             - See the area map\n"
        "  |wstats|n           - Your character sheet\n"
